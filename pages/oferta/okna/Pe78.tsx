      ...
      <div className='grid lg:grid-cols-2 grid-cols-1 gap-4 '>
          ...
          <div>
            ...
            {select ? (<div className='text-lg px-4'>
                <p className='border-y-2 border-orange-700'>System o trzykomorowej konstrukcji przeznaczony do budowy ścianek stałych i okien o podwyższonej odporności na włamanie w klasie RC4.</p>
                <ul className='list-disc'>
                  ...
                  <li className='border-y-2 border-orange-700 my-2'>brak konieczności stosowania krat lub rolet antywłamaniowych</li>
                  ...
                  <li className='border-b-2 border-orange-700 my-2'>zakres szklenia do 78mm pozwala na zastosowanie wytrzymałych pakietów szkła w klasie minimum P6B</li>
                  <li className='border-b-2 border-orange-700 my-2'>szyba nie jest klejona do profili, co zdecydowanie ułatwia i przyspiesza montaż konstrukcji</li>
                  <li className='border-b-2 border-orange-700 my-2'>wysoka izolacyjność termiczna Uw do 0,9 W/m2K</li>
