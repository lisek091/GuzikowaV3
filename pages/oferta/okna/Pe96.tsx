      ...
      <div className='grid lg:grid-cols-2 grid-cols-1 gap-4 '>
          ...
          <div>
            ...
            {select ? (<div className='text-lg px-4'>
                <p className='border-y-2 border-blue-300'>System o trzykomorowej konstrukcji profili z rowkiem okuciowym w standardzie Euro. Jest przeznaczony do konstrukcji okien o bardzo wysokich wymogach izolacyjności termicznej.</p>
                <ul className='list-disc'>
                  ...
                  <li className='border-y-2 border-blue-300 my-2'>możliwość wykonywania konstrukcji o dużych gabarytach</li>
