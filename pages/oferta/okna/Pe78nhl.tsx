          ...
          <div>
            ...
            {select ? (<div className='text-lg px-4'>
                ...
                <ul className='list-disc'>
                  <li className='border-b-2 border-orange-700 my-2'>wysoka izolacyjność termiczna - dzięki zastosowaniu wielokomorowej przekładki termicznej 42 mm oraz dwukomponentowej uszczelki centralnej</li>
