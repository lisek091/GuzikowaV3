...
const ContactInfo = () => {
  return (
    <div className='m-8 xl:flex justify-center dark:text-white'>
      <div className=''>
        ...
        <div className="border-2 border-orange-300 mx-8 my-2 border-spacing-6 rounded-full hidden xl:flex"></div>
