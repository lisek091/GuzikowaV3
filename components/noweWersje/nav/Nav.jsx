...
const Nav = () => {
    ...
    const navigation = [
        { title: "Okna PCV", isDrapdown: true, navs: OknaPCVNavs },
        { title: "Okna aluminiowe", isDrapdown: true, navs: OknaAluminioweNavs },
        { title: "Systemy przesuwne PCV", isDrapdown: true, navs: SystemyPrzesuwnePCVNavs },
