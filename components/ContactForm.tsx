...
const ContactForm = () => {
  ...
  return (
    <div className='flex'>
      <div>
        <Input id='name' label='Imię i nazwisko' onChange={(e: any) => setName(e.target.value)} value={name} type='text' />
      ...
      <div className='block mx-6 '>
        <textarea style={{resize:"none"}} id="opis" rows={5} cols={50} placeholder='Opis problemu - FUNKCJA NIE DZIAŁA' className='border-2 border-black' disabled/>
        <div className='flex'>
